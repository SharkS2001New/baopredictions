...
if ($payload === null) {
  ...
  echo bao_matches_html($payload['games'], ['title' => 'Yesterday\'s results']);
}
?>
...
<!--BAO_ARTICLE_START-->
<section class="section section-muted seo-article-section"><div class="wrap"><article class="content-article prose"><header class="article-header"><h2 class="article-title">Why we keep losing tips visible</h2></header><div class="article-content"><p>A tips site that deletes losers is not one you should trust. Yesterday's page is the daily proof layer; the Results page is the longer archive.</p></div></article></div></section>
<!--BAO_ARTICLE_END-->
<section class="section"><div class="wrap"><h2 class="section-title">Yesterday&#039;s Results FAQ</h2><ul class="faq-list"><li><details><summary>Why keep losing tips?</summary><p>A site that deletes losers is not trustworthy. Yesterday is the daily proof layer.</p></details></li><li><details><summary>Is this the full archive?</summary><p>Yesterday is the daily slice; Results is the longer track record.</p></details></li><li><details><summary>When does Yesterday update?</summary><p>After the previous day&#039;s fixtures settle.</p></details></li><li><details><summary>Can I compare to today?</summary><p>Yes — use Today for live tips and Yesterday for verification.</p></details></li><li><details><summary>Do voids count as losses?</summary><p>Postponements are generally excluded from win-rate maths.</p></details></li><li><details><summary>Are tips free to review?</summary><p>Yes.</p></details></li></ul></div></section>
