...
if ($payload === null) {
  ...
  echo bao_matches_html($payload['games'], ['title' => 'Must-win teams']);
}
?>
...
<!--BAO_ARTICLE_START-->
<section class="section section-muted seo-article-section"><div class="wrap"><article class="content-article prose"><header class="article-header"><h2 class="article-title">What “must-win” means on Bao Predictions</h2></header><div class="article-content"><p>Motivation changes effort and risk tolerance. Sides fighting relegation with a shrinking run-in often press higher and leave more space — that can help a goals lean as much as a result lean. We only tag must-win when both the narrative and the underlying numbers agree.</p></div></article></div></section>
<!--BAO_ARTICLE_END-->
<section class="section"><div class="wrap"><h2 class="section-title">Must-Win Teams FAQ</h2><ul class="faq-list"><li><details><summary>What does must-win mean here?</summary><p>Table pressure (relegation, Europe, title) plus 85%+ confidence — not just a big club favourite.</p></details></li><li><details><summary>Can a favourite miss this list?</summary><p>Yes, if confidence or motivation does not clear the bar.</p></details></li><li><details><summary>Are these bankers?</summary><p>They are our strongest published leans that day — still not guarantees.</p></details></li><li><details><summary>Do must-win sides always win?</summary><p>No. Pressure can also create chaotic games. Check Results.</p></details></li><li><details><summary>How often does the list update?</summary><p>Daily, and again if late news kills a lean.</p></details></li><li><details><summary>Related pages?</summary><p>Sure Bets Today and 1X2 Predictions cover overlapping high-conviction angles.</p></details></li></ul></div></section>
